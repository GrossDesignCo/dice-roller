  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css?family=Inter:300,400,500&display=optional"
        />

        <meta name="twitter:card" content="summary" />
        <meta name="twitter:url" content="https://yourdomain.com" />
        <meta name="twitter:title" content="Dice Roller" />
        <meta
          name="twitter:description"
          content="Best Dice Roller in the world"
        />
        <meta
          name="twitter:image"
        ...
        <meta
          ...
          content="Best Dice Roller in the world"
        />
        <meta property="og:site_name" content="Dice Roller" />
